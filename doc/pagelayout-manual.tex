...
To align the baselines use the |baselinesnap| option and set the baseline dimension, for example |baselinesnap=\baselineskip|.
\par
...
With the |orientation| option you can set the Exif orientation flag (1-8).
To flip a graphic horizontally or vertically use the options |hflip| or |vflip|.
