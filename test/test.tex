...
\documentclass[twoside,bleed=3mm,safetymargin=2mm,beginleft]{xput}
...
\makeatletter
\newcommand\printgrid{
  w=\mim\xput@gridwidth\ h=\mim\xput@gridheight\
  r=\the\numexpr 1000*\number\xput@gridwidth/\xput@gridheight\relax\\
  \foreach \gridI in {1,...,\xput@rowscount} {
    \ifnum\gridI=1
      \ifnum\xput@get{if1F}=1\textbf{\mim{\xput@get{1HR}}}\else\mim{\xput@get{1HR}}\fi\ /\
      \ifnum\xput@get{1C}>0
        \ifnum\xput@get{if1-1F}=1\textbf{\mim{\xput@get{1-1WR}}}\else\mim{\xput@get{1-1WR}}\fi\
      \fi
      \ifnum\xput@get{1C}>1
        \ifnum\xput@get{if1-2F}=1\textbf{\mim{\xput@get{1-2WR}}}\else\mim{\xput@get{1-2WR}}\fi\
      \fi
      \ifnum\xput@get{1C}>2
        \ifnum\xput@get{if1-3F}=1\textbf{\mim{\xput@get{1-3WR}}}\else\mim{\xput@get{1-3WR}}\fi\
      \fi
      \\
    \else
      \ifnum\gridI=2
        \ifnum\xput@get{if2F}=1\textbf{\mim{\xput@get{2HR}}}\else\mim{\xput@get{2HR}}\fi\ /\
        \ifnum\xput@get{2C}>0
          \ifnum\xput@get{if2-1F}=1\textbf{\mim{\xput@get{2-1WR}}}\else\mim{\xput@get{2-1WR}}\fi\
        \fi
        \ifnum\xput@get{2C}>1
          \ifnum\xput@get{if2-2F}=1\textbf{\mim{\xput@get{2-2WR}}}\else\mim{\xput@get{2-2WR}}\fi\
        \fi
        \ifnum\xput@get{2C}>2
          \ifnum\xput@get{if2-3F}=1\textbf{\mim{\xput@get{2-3WR}}}\else\mim{\xput@get{2-3WR}}\fi\
        \fi
        \\
      \else
        \ifnum\gridI=3
          \ifnum\xput@get{if3F}=1\textbf{\mim{\xput@get{3HR}}}\else\mim{\xput@get{3HR}}\fi\ /\
          \ifnum\xput@get{3C}>0
            \ifnum\xput@get{if3-1F}=1\textbf{\mim{\xput@get{3-1WR}}}\else\mim{\xput@get{3-1WR}}\fi\
          \fi
          \ifnum\xput@get{3C}>1
            \ifnum\xput@get{if3-2F}=1\textbf{\mim{\xput@get{3-2WR}}}\else\mim{\xput@get{3-2WR}}\fi\
          \fi
          \ifnum\xput@get{3C}>2
            \ifnum\xput@get{if3-3F}=1\textbf{\mim{\xput@get{3-3WR}}}\else\mim{\xput@get{3-3WR}}\fi\
          \fi
          \\
        \fi
      \fi
