...
\documentclass[twoside,fanfold,beginright,bottommargin=10mm,pagecolor=black,color=white]{pagelayout}
\usepackage{hyperref}
\input{_config}
...
\begin{document}
  ...
  \page[before page=secondary]{}
  \pagenumbering{arabic}
  \template{f}{
    \text[parbox]{
      \section{One}
      \subsection{Why is the TOC Color Wrong?}
    }
  }
  \template{f}{
    \text[parbox]{
  ...
  \template[double,page color=yellow!10!black]{ff}{
    ...
    \text[parbox]{
      \section{Three}
      \subsection{The TOC Page is Wrong}
      \thepage
    }
    \text[parbox]{
      \section{Four}
